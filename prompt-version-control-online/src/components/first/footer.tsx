...
export function Footer() {
  return (
    <footer className="flex flex-col gap-y-5 rounded-lg px-7 py-5 ">
      <hr className="w-full"/>
      ...
      <div className="flex flex-col justify-between gap-y-5 container mx-auto p-2 md:flex-row md:items-center">
